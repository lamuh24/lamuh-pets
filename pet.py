...
KAIRO_SPRITESHEET_PATH = r'C:\Users\qchee\.codex\avatars\kairo\kairo_extended_spritesheet_12x8.webp'
LAMUH_SPRITESHEET_PATH = 'interaction_import_pack/lamuh_extended_spritesheet_12x8.webp'
...
DUO_COMBAT_STRIP_PATH = os.path.join(os.path.dirname(__file__), 'duo_lamuh_kairo_combat_strip.png')
...
class DesktopPet:
    def __init__(self, root):
        ...
        self.state_file = f'pet_state_{safe_name}.json'
    ...
    def collaboration_loop(self):
        try:
            if not self.is_dragging and os.path.exists('world_state.json'):
                with open('world_state.json', 'r') as f:
                    world = json.load(f)
